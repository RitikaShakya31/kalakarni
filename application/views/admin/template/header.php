          ...
          <nav class="main-menu">
            <ul class="nav metismenu">
             ...
             <li class="nav-dropdown">
                <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-arrow-right" aria-hidden="true"></i><span>Order List</span></a>
              ...
              <li class="nav-dropdown">
                <a href="<?= base_url('admin_Dashboard/view_category'); ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i><span>Product Category</span></a>
              ...
              <li>
                <a href="<?= base_url('admin_Dashboard/budget'); ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i><span>Home budget</span></a>
              </li>

              <li class="nav-dropdown">
                <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-arrow-right" aria-hidden="true"></i><span>Add On data</span></a>
                <ul class="collapse nav-sub" aria-expanded="true">
                  <li>
              ...
              <li>
                <a href="<?= base_url('admin_Dashboard/length'); ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i><span> Length</span></a>
              </li>
              <li>
                <a href="<?= base_url('admin_Dashboard/fabric'); ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i><span>Fabric</span></a>
              </li>
              <li>
                <a href="<?= base_url('admin_Dashboard/pattern'); ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i><span>Pattern</span></a>
              </li>
            </ul>
          </nav>
        </div>
