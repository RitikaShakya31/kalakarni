                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  style="display:none"> <a href="<?php echo base_url() . 'admin_Dashboard/disable/' . $row['pid'] . '/promocode/' . (($row['status'] == 1) ? '0' : '1'); ?>" class="btn btn-light delete"><?php if ($row['status'] == 0) { ?><i class="fas fa-eye"></i><?php } else { ?> <i class="fas fa-eye-slash"></i><?php } ?></a></td>
                                                        <td>
