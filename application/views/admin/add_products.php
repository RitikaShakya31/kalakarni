                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url() . 'admin_Dashboard/addproducts' ?>" method="post"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="category_id" id="category_id">
                                                    ...
                                                    <?php foreach ($category as $row) { ?>
                                                        <option value="<?= $row['category_id']; ?>"><?= $row['cat_name']; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-8">
                                                ...
                                                <div class="pos-relative">
                                                    <input class="form-control pd-r-80" required="" type="file"
                                                        name="img[]" multiple>
                                                </div>
                                            </div>
