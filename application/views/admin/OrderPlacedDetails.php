                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <ul class="actions top-right">
                                    <li>
                                        <a href="javascript:void(0)" data-q-action="card-expand"><i
                                                class="icon dripicons-expand-2"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="bs4-table" class="table table-striped table-bordered"
                                        ...
                                        if (!empty($checkoutProduct)) {
                                            foreach ($checkoutProduct as $row) {
                                                ...
                                                $data = getSingleRowById('products_image', array('product_id' => $row['product_id']));
                                                $imgData = $data['pi_name'];
                                                ?>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td><img src="<?= base_url() ?>uploads/products/<?= $data['pi_name'] ?>"
                                            ...
                                            if (!empty($checkout)) {
                                                foreach ($checkout as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $getUserType['type'] == 1 ? 'Guest' : 'User'; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['name']; ?>
                                                        </td>
