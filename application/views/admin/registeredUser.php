                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['type'] == 1 ? 'Guest' : 'User' ; ?></td>
                                                        <td><?php echo $row['fullname']; ?></td>
                                                        <td><?php echo $row['emailid']; ?></td>
                                                        <td><?php echo $row['contact']; ?></td>
                                                        <!-- <td><?php echo $row['password']; ?></td> -->
                                                        <td>
                                                            <a href="<?php echo base_url() . 'admin_Dashboard/userorderPlaced/' . $row['reg_id']; ?>" class="btn btn-info"><i class="fas fa-shopping-cart"></i> (<?= $orderCount ?>)</a>
                                                        </td>
                                                        <!--<td>-->
