                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label class="">fabric category</label>
                                        <input class="form-control" type="text" name="fabric" />
                                    </div>
                            ...
                            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'admin_Dashboard/deletefabric/' . $row['id']; ?>" class="btn btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                                            </td>
