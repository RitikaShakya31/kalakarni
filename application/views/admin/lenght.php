                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label class="">Length category</label>
                            ...
                            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'admin_Dashboard/deletelength/' . $row['id']; ?>" class="btn btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                                            </td>
